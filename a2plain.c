...
static void small_map_row_major(A2 array2, A2Methods_smallapplyfun apply, 
                                void *cl){
        struct small_closure my_closure = { apply, cl};
        UArray2_map_row_major(array2, apply_small, &my_closure);
}

static void small_map_col_major(A2 array2, A2Methods_smallapplyfun apply, 
                                void *cl){
        struct small_closure my_closure = { apply, cl};
        UArray2_map_col_major(array2, apply_small, &my_closure);
}
